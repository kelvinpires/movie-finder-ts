...
export const HomePage = () => {
  ...
  const [trending, setTrending] = useState<ContentResponse[]>([]);
  const [popularMovies, setPopularMovies] = useState<ContentResponse[]>([]);
  const [popularSeries, setPopularSeries] = useState<ContentResponse[]>([]);
